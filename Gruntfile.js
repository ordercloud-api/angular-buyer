module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    /**
     * `grunt-less-imports` handles importing of all LESS files into the src/less/main.less file.
     * The app_files.import_less array in the build.config.js file drives where to look for these files.
     */
    less_imports: {
      build: {
        options: {
          import: 'less',
          inlineCSS: false,
          banner: '// This file was generated by the grunt-less-imports task in the build process.  Do not alter this file, any changes you make will be overwritten the next time you build.'
        },
        src: '<%= app_files.import_less %>',
    ...
    less: {
      build: {
        files: {
          '<%= build_dir %>/assets/<%= pkg.name %>-<%= pkg.version %>.css': '<%= less_imports.build.dest %>'
        },
        options: {
          strictImports:true
        }
