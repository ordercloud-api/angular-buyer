...
function FavoriteProductController($scope, sdkOrderCloud, toastr){
    var vm = this;
    ...
    function checkHasFavorites(){
        if($scope.currentUser && $scope.currentUser.xp && $scope.currentUser.xp.FavoriteProducts){
            ...
            sdkOrderCloud.Me.Patch({xp:$scope.currentUser.xp})
                .then(function(){
                    vm.hasFavorites = true;
                })
                .catch(function(ex){
    ...
    function addProduct(existingList){
        ...
        sdkOrderCloud.Me.Patch({xp: {FavoriteProducts: existingList}})
            .then(function(data){
    ...
    function removeProduct(){
        ...
        sdkOrderCloud.Me.Patch({xp: {FavoriteProducts: updatedList}})
            .then(function(){
