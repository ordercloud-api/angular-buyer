...
function ocZoom() {
    return {
        ...
        template:
            ...
            '</style>'+
            '<div>'+
            '<img class="jetzoom img-responsive" ng-src="{{images.Small}}"/>'+
            '</div>',
        link: function($scope) {
            var smallImg = $scope.images.Small;
            var largeImg = $scope.images.Large;
            var options = {
                tintColor: '#fff',
                tintOpacity: .25,
                fadeTime: 750,
            ...
            jetZoomInstance.loadImage(smallImg, largeImg);
